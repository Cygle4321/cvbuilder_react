...
const CVPreviewModern: React.FC<Props> = ({ personalDetails, file, theme, experiences, educations, languages, skills, hobbies, download, ref }) => {
    return (
        <motion.div ref={ref} layout initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className={`flex flex-row-reverse p-16 w-[950px] h-[1200px] shadow-lg bg-base-100 text-base-content ${download ? 'mb-10' : ''}`} data-theme={theme}>
            <div className="flex flex-col w-1/3">

                <div className="h-80 rounded-full border-8 border-primary overflow-hidden">
                    {file && (
                        < Image
            ...
            <div className="w-2/3 mr-8">
                <div className="w-full flex flex-col space-y-4">
                    ...
                    <h2 className="uppercase font-bold text-5xl text-primary">
                        {personalDetails.postSeeking}
                    </h2>
                    <p className="break-all w-full text-justify text-sm">
